		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Fiori App",
									"targetURL": "#commindsetappsproject2-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"commindsetappsproject2-display": {
								"semanticObject": "commindsetappsproject2",
								"action": "display",
								"description": "A Fiori application for JSON data change to Tree Structure using JS",
								"title": "Fiori App",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.mindset.apps.project2",
									"url": sap.ui.require.toUrl("com/mindset/apps/project2")
								}
							}
						}
					}
